...
startup {
  ...
  settings.CurrentDefaultParent = "route";
    ...
    settings.Add("p28", false, " Reached DARPA Chief in Holding Cells");
    settings.Add("p36", true, " Reached Guard Encounter");
    ...
    settings.Add("p125", false, " Cornered Meryl in Nuke Building B1");
    settings.Add("p133", true, " Nuke Building B1 ⮞ Commander's Room");
    settings.Add("p139", true, " Reached Psycho Mantis");
    settings.Add("p151", true, " Commander's Room ⮞ Caves");
    ...
    settings.Add("area14a_area13a_p163", true, " Caves ⮞ Commander's Room");
    settings.Add("area13a_area10a_p164", true, " Commander's Room ⮞ Nuke Building B1");
    settings.Add("area10a_area13a_p164", true, " Nuke Building B1 ⮞ Commander's Room");
    settings.Add("area13a_area14a_p164", true, " Commander's Room ⮞ Caves");
    ...
    settings.Add("area10a_area13a_capture", true, " Nuke Building B1 ⮞ Commander's Room");
    settings.Add("area13a_area14a_capture", true, " Commander's Room ⮞ Cave");
    ...
    settings.Add("p228", true, " Reached Hind D");
    ...
    settings.Add("area21a_area22a_p245", false, " Blast Furnace ⮞ Cargo Elevator Top");
    settings.Add("p251", true, " Reached elevator ambush in Cargo Elevator");
    settings.Add("p254", true, " Defeated elevator ambush in Cargo Elevator");
    settings.Add("area22c_area22b_p254", true, " Cargo Elevator Mid ⮞ Cargo Elevator Lower");
